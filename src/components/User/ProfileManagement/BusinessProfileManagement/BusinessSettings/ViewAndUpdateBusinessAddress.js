...
import "../../UserProfileManagement/UserSettings/ViewAndUpdateAddress.css";
import { IconButton } from "@mui/material";
import ArrowBackIcon from "@mui/icons-material/ArrowBack";

const ViewAndUpdateBusinessAddress = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:5196/api/Address/Business/${businessId}`)
      .then((response) => {
        axios
...
export default ViewAndUpdateBusinessAddress;
